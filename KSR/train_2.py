    ...
    def run(self, data_dir, model_dir, args):
        ...
        for epoch in range(args.epochs):
            ...
            with torch.no_grad():
                ...
                #저장 기준을 accuracy로 할건지 loss로 할건지 결정하는 코드 짜기
                # 기존 코드의 문제점 꼭 best accuracy가 best loss로 이어지나 또는 vice versa?
                ...
                if val_loss < best_val_loss:
                    print(f"New best model for val accuracy : {val_acc:4.2%}! saving the least loss value model..")
                    torch.save(model.module.state_dict(), f"{save_dir}/least_loss.pth")
                ...
                print(best_val_acc_epoch, best_val_loss_epoch)
