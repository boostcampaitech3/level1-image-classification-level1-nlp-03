...
#grid_image n 수정하면 텐서보드 상에 뜨는 이미지 숫자 늘릴 수 있음
...
class Lite(LightningLite):
    def run(self, data_dir, model_dir, args):
        ...
        scheduler = StepLRScheduler(
            ...
            warmup_t=5,   # 예 때문에 epoch 15이상 시도 했었음. https://fastai.github.io/timmdocs/stepLR#decay_t 참고 -> 중간에 파라미터 설명 있음
            t_in_epochs=False,
        )
...
#     parser.add_argument("--resize", nargs="+", type=list, default=[128, 96], help="resize size for image when training")
    parser.add_argument("--resize", nargs="+", type=list, default=[384, 384], help="resize size for image when training") #<-모델 맞추기 위함
    parser.add_argument("--batch_size", type=int, default=64, help="input batch size for training (default: 64)")
#     parser.add_argument("--valid_batch_size", type=int, default=1000, help="input batch size for validing (default: 1000)")
    parser.add_argument("--valid_batch_size", type=int, default=64, help="input batch size for validing (default: 1000)") #모델이 너무 큼
    parser.add_argument("--model", type=str, default="BaseModel", help="model type (default: BaseModel)") #swin으로
    parser.add_argument("--optimizer", type=str, default="SGD", help="optimizer type (default: SGD)") #Adam -> AdamW
    parser.add_argument("--lr", type=float, default=1e-3, help="learning rate (default: 1e-3)") # -> 2e-5
    # parser.add_argument("--val_ratio", type=float, default=0.1, help="ratio for validaton (default: 0.2)")
    parser.add_argument("--val_ratio", type=float, default=0.2, help="ratio for validaton (default: 0.2)") #내 데이터는 0.2가 적합
    parser.add_argument("--criterion", type=str, default="cross_entropy", help="criterion type (default: cross_entropy)") # f1
